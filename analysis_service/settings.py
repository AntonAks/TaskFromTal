...
class Settings(BaseSettings):
    ...
    ANALYSIS_DATABASE_URL: str = f"postgresql://{analysis_db_user}:{analysis_db_password}@analysis-db:5432/{analysis_db_name}"
    MAIN_DATABASE_URL: str = f"postgresql://{main_db_user}:{main_db_password}@main-db:5432/{main_db_name}"
