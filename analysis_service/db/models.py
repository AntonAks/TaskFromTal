...
class OrganizationStatistics(Base):
    ...
    organization_name: Mapped[str] = mapped_column(String(1024), nullable=False, primary_key=True)
    quantity: Mapped[int] = mapped_column(Integer)


class OrganizationTypeStatistics(Base):
    __tablename__ = 'organization_type_statistics'
    organization_type: Mapped[str] = mapped_column(String(1024), nullable=False, primary_key=True)
